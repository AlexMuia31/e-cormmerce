  ...
  return (
    <div className="mt-4">
      <a
        href={checkoutUrl}
        target="_self"
        className="group flex w-full items-center justify-center gap-2 rounded-lg bg-brand-navy px-6 py-3 text-base font-semibold text-white shadow-md transition-all duration-200 hover:bg-opacity-90 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-brand-navy/50 focus:ring-offset-2"
      >
